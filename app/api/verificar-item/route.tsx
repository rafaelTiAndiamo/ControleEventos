...
function mapPlanilhaToFormData(clienteRow: string[], itensRows: ItemPlanilha[]): FormDataType {
  ...
  : [],
    ...
    cardapio: {
      SOFT: itensRows.filter(i => i.tipo === "SOFT").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor ?? "", qtdTotal: i.qtdTotal || "0" })),
      CANAPÉ: itensRows.filter(i => i.tipo === "CANAPÉ").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor ?? "", qtdTotal: i.qtdTotal || "0" })),
      "PRATO PRINCIPAL": itensRows.filter(i => i.tipo === "PRATO PRINCIPAL").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor ?? "", qtdTotal: i.qtdTotal || "0" })),
      ILHA: itensRows.filter(i => i.tipo === "ILHA").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor ?? "", qtdTotal: i.qtdTotal || "0" })),
      "SOBREMESA|FRUTA": itensRows.filter(i => i.tipo === "SOBREMESA|FRUTA").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor ?? "", qtdTotal: i.qtdTotal || "0" })),
      
      ANTIPASTO: itensRows.filter(i => i.tipo === "ANTIPASTO").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor ?? "", qtdTotal: i.qtdTotal || "0" })),
      SALADAS: itensRows.filter(i => i.tipo === "SALADAS").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor ?? "", qtdTotal: i.qtdTotal || "0" })),
      ACOMPANHAMENTOS: itensRows.filter(i => i.tipo === "ACOMPANHAMENTOS").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor ?? "", qtdTotal: i.qtdTotal || "0" })),
    },
