...
function mapPlanilhaToFormData(clienteRow: string[], itensRows: ItemPlanilha[]): FormDataType {
  ...
  return {
    ...
    cardapio: {
      SOFT: itensRows.filter(i => i.tipo === "SOFT").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor!, qtdTotal: i.qtdTotal! })),
      CANAPÉ: itensRows.filter(i => i.tipo === "CANAPÉ").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor!, qtdTotal: i.qtdTotal! })),
      "PRATO PRINCIPAL": itensRows.filter(i => i.tipo === "PRATO PRINCIPAL").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor!, qtdTotal: i.qtdTotal! })),
      ILHA: itensRows.filter(i => i.tipo === "ILHA").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor!, qtdTotal: i.qtdTotal! })),
      "SOBREMESA|FRUTA": itensRows.filter(i => i.tipo === "SOBREMESA|FRUTA").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor!, qtdTotal: i.qtdTotal! })),
      ANTIPASTO: itensRows.filter(i => i.tipo === "ANTIPASTO").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor!, qtdTotal: i.qtdTotal! })),
      SALADAS: itensRows.filter(i => i.tipo === "SALADAS").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor!, qtdTotal: i.qtdTotal! })),
      ACOMPANHAMENTOS: itensRows.filter(i => i.tipo === "ACOMPANHAMENTOS").map(i => ({ codigo: i.codigo!, nome: i.nome!, qtd: i.qtd!, grupo: i.grupo!, valorPorPax: i.valor!, qtdTotal: i.qtdTotal! })),
    },
